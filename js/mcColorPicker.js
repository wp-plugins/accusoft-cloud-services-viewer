...
MC.ColorPicker=function()
{
	...
	c.prototype=
	{
		...
		f:function(a)
		{
			a.cancelBubble=true;a.f&&a.f()
		},
		
		g:function()
		{
			for(var b,a=this.c,h=["00","00","11","22","33","44","55","66","77","88","99","AA","BB","CC","DD","EE","FF","TT"],g=0;g<18;g++)
			{
				b=this.e(h[g],h[g],h[g]);
				a.appendChild(b)
			}
			this.d(a);
		...
		h:function()
		{
			...
			this.r.id="colorpicker";
			this.a=document.createElement("div");
			this.a.id="hexBox";
			this.b=document.createElement("div");
			this.b.id="bgBox";
			this.c=document.createElement("div");
			this.c.id="colorContainer";
			this.j();
			...
			{
				if(a.i>-1)a.S[a.i].style.zIndex=1;a.o()
			})
		},
		
		j:function()
		{
			b(this.c,"mouseover",this.k);
		...
		m:function()
		{
			for(var c=document.getElementsByTagName("input"),e=this,b=0,f=c.length;b<f;b++)
			if(d(c[b].className))
			{
				var a=this.R.length;
				if(c[b].i===undefined)
		...
		p:function(c)
		{
			var a=this;b(c,"click",function(b)
			{
